...
int ueventd_main(const UeventdConfiguration& ueventd_configuration, bool first_run) {
    ...
    if (fs_mgr_get_boot_config("modalias_handling_delay_ms", &tmp)) {
        android::base::ParseUint(tmp, &modalias_handling_delay_ms);
    }
    ...
    if (ueventd_configuration.enable_modalias_handling) {
        ...
        uevent_handlers.emplace_back(std::make_shared<ModaliasHandler>(base_paths, modalias_handling_delay_ms));
    }
